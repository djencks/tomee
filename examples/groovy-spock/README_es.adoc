...
[source,groovy]
----
include::8.0@:example$groovy-spock/src/main/groovy/org/superbiz/groovy/Hello.groovy[tag=content]
----
...
[source,groovy]
----
include::8.0@:example$groovy-spock/src/test/groovy/org/superbiz/groovy/HelloSpecification.groovy[tag=content]
----
