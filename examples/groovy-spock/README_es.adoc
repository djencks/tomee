...
[source,groovy]
----
include::8.0@:example$src/main/groovy/org/superbiz/groovy/Hello.groovy[tag=content]
----
...
[source,groovy]
----
include::8.0@:example$src/test/groovy/org/superbiz/groovy/HelloSpecification.groovy[tag=content]
----
