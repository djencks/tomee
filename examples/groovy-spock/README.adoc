...
[source,groovy]
----
include::example$groovy-spock/src/main/groovy/org/superbiz/groovy/Hello.groovy[tag=content]
----
...
[source,groovy]
----
include::example$groovy-spock/src/test/groovy/org/superbiz/groovy/HelloSpecification.groovy[tag=content]
----
