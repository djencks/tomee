...
[source,groovy]
----
include::example$src/main/groovy/org/superbiz/groovy/Hello.groovy[tag=content]
----
...
[source,groovy]
----
include::example$src/test/groovy/org/superbiz/groovy/HelloSpecification.groovy[tag=content]
----
