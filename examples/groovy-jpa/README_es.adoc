...
[source,java]
----
include::8.0@:example$groovy-jpa/src/main/groovy/org/superbiz/groovy/Person.groovy[tag=content]
----
...
[source,java]
----
include::8.0@:example$groovy-jpa/src/main/resources/META-INF/persistence.xml[tag=content]
----
