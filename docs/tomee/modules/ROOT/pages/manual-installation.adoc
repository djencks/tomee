...
//FIXME CHOOSE ONE
xref:0.0@tomee::tomcat.adoc[]
xref:0.1@tomee::tomcat.adoc[automatic installation] which we normally recommend. In
...
Once Tomcat has been 
//FIXME CHOOSE ONE
xref:0.0@tomee::tomcat-installation.adoc[]
xref:0.1@tomee::tomcat-installation.adoc[installed] , the
