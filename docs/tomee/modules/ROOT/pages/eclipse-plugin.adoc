...
Just the same as getting involved with any part of OpenEJB -- send a mail to the xref:0.1@tomee::mailing-lists.adoc#developermailinglist[OpenEJB Dev list] and say "Hi!".
