...
xref:application-composer/history.adoc[History] page will explain you where does it come from
...
further, xref:application-composer/advanced.adoc[Advanced] page is the one you need to look!
