...
For other environments, you can simply xref:{common-vc}::downloads-ng.adoc[download an openejb-3.1.zip] or later and include all the jars under the `lib/` directory in your classpath.
