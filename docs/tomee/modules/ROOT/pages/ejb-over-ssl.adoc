...
feature] By default, the ejbds protocol connects with SSL_DH_anon_WITH_RC4_128_MD5. That means your connection is encrypted and the integrity of the transmission is verified.
...
To do this, simply select one or more secure cipher suites that your J2SE provider supports from
...
The javax.net.ssl.trustStore and javax.net.ssl.keyStore JVM properties
