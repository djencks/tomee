...
//not compared with common
//Is this page obsolete, replaced with a generated page??

See also the xref:examples::index.adoc[examples page] for downloadable, executable and code-focused view of Java EE and TomEE.
...
* xref:unit-testing-transactions.adoc[Unit Testing Transactions MISSING!]
* xref:testcase-with-testbean-inner-class.adoc[TestCase with TestBean inner-class MISSING!]
