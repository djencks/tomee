...
The activemq.xml file format requires a number of Spring dependencies, and is therefore not included in the distribution by default.
...
It should be `javax.jms.Queue` or
`javax.jms.Topic`.
