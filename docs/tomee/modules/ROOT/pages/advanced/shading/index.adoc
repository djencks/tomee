...
NOTE: see xref:../tomee-embedded/index.adoc[TomEE Embedded] page for more information about tomee embedded options.

IMPORTANT: this shade uses TomEE Embedded but you can do the same with an xref:../applicationcomposer/index.adoc[Application Composer] application.
