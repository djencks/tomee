...
In a standalone instance you generally don't need (or want) to specify anything to do a lookup.
Doing so you will inherit from the contextual environment:
...
See xref:../../admin/cluster/index.adoc[Cluster] page for more details on the options.
