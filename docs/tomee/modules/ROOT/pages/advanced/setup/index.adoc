...
You can use TomEE as described on xref:admin/file-layout.adoc[Directory Structure] page but in production it is better to split TomEE and application binaries and configuration.

Idea is to have this kind of layout (the root is the one you prefer):

ifndef::backend-pdf[]

//TODO find what made this work... document it, use it or something like it...
//[#filetree.col-md-4]
[source]
----
[{
