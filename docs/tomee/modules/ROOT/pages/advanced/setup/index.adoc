...
You can use TomEE as described on xref:admin/file-layout.adoc[Directory Structure] page but in production it is better to
...
// I think this is supposed to be an expandable tree and displayed as a file system hierarchy.
// was [#filetree.col-md-4]
[source, yaml]
[{
    label: '/some/path',
