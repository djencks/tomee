...
Add these to the TomEE bin directory.
Add the following to setenv.sh on *nix:
...
Add your log4j2.xml config in the `bin` directory.
Here's a simple config you can use to help you get started:
