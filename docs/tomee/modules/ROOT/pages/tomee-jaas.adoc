...
`$CATALINA_BASE/conf/` folder. `users.properties` file contains user name and associated password entries, ex.:
...
If other names are used, the files must be placed in
