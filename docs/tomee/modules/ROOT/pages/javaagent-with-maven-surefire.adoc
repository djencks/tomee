...
javaagent enabled --> org.apache.maven.plugins maven-surefire-plugin pertest
...
target/ directory --> org.apache.maven.plugins maven-dependency-plugin copy process-resources copy org.apache.openejb openejb-javaagent 3.0
