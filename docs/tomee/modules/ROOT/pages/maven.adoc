...
http://maven.apache.org/[Maven] usage for users that are not all that familiar with http://maven.apache.org/[Maven] projects.
...
http://subversion.apache.org/[Subversion] and that you can run *svn --version* from any command prompt or console.
