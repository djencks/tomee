* xref:8.0@examples::index.adoc[[examples page]
...
* xref:0.0@tomee::getting-started-with-eclipse-and-webby.adoc[Get started with Eclipse (m2e-Webby)]
...
* xref:0.0@tomee::testcase-with-testbean-inner-class.adoc[TestCase with TestBean inner-class]
